...
function Sequence( jobs ) {
  ...
  return function flow() {
    ...
    if ( arguments.length ) {
      ...
      let _arguments = [], i = -1, l = arguments.length
      while ( ++i < l ) _arguments[ i ] = arguments[ i ]
    ...
    function next( parameters ) {
      ...
      function asyncNext( rArgs ) {
        ...
        if ( lock === false ) return void 0

        if ( index !== counter ) return void 0
      ...
      const thisArg = {
        ...
        get await() {
          ...
          return function cb() {
            ...
            if ( pending === false ) return void 0
